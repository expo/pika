...
package io.github.expo.pika.intrinsic

import io.github.expo.pika.Identifiers
import io.github.expo.pika.Identifiers.withPackageName
import io.github.expo.pika.bytecode.BytecodePoet
import io.github.expo.pika.ir.hasIntrospectableAnnotation
      ...
      Identifiers.IS_INTROSPECTABLE_FUNCTION_NAME -> {
        ...
        if (typeDescriptor != null) {
          bytecodePoet.reifyMarker(
            ...
            Identifiers.IS_INTROSPECTABLE_FUNCTION_NAME,
            typeDescriptor,
            "io/github/expo/pika/IsIntrospectableKt",
      ...
      Identifiers.INTROSPECTION_OF_FUNCTION_NAME -> {
        ...
        if (typeDescriptor != null) {
          bytecodePoet.reifyMarker(
            ...
            Identifiers.INTROSPECTION_OF_FUNCTION_NAME,
            typeDescriptor,
            "io/github/expo/pika/IntrospectionOfKt",
  ...
  private fun generatePTypeDescriptor(type: IrType, bytecodePoet: BytecodePoet, functionName: String) {
    ...
    if (typeDescriptor != null) {
      bytecodePoet.reifyMarker(
        ...
        functionName,
        typeDescriptor,
        "io/github/expo/pika/TypeDescriptorOfKt",
        "throwNonReifiedTypeDescriptorError",
        "()Lio/github/expo/pika/PTypeDescriptor;"
      )
      return
    }
